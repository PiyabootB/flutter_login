...
//
//     final apiCv = apiCvFromJson(jsonString);

import 'dart:convert';

ApiCv apiCvFromJson(String str) => ApiCv.fromJson(json.decode(str));

String apiCvToJson(ApiCv data) => json.encode(data.toJson());
...
class ApiCv {
    ...
    factory ApiCv.fromJson(Map<String, dynamic> json) => ApiCv(
