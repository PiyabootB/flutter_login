...
CovidStatus covidStatusFromJson(String str) => CovidStatus.fromJson(json.decode(str));

String covidStatusToJson(CovidStatus data) => json.encode(data.toJson());
...
class CovidStatus {
    ...
    factory CovidStatus.fromJson(Map<String, dynamic> json) => CovidStatus(
